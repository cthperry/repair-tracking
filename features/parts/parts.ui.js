...
class PartsUI {
  constructor() {
    ...
    this.catalogQuick = ''; // '' | ACTIVE | INACTIVE | ZERO | LOW
        ...
        <div class="parts-filters-panel panel compact" id="parts-filters-panel" style="display:${this.filtersPanelOpen ? 'block' : 'none'};">
          <div class="panel-row">
            ...
            <div class="panel-right">
              <button class="btn" onclick="PartsUI.clearFilters()">清除</button>
            </div>
          </div>
...
Object.assign(PartsUI, {
  ...
  clearRepairFilter() {
    if (!window.partsUI) return;
    window.partsUI.contextRepairId = '';
    window.partsUI.update();
  },
